...
|-----------|----------|----------|
| Repo direction & cross-cutting decisions | Leela | Team requests, trade-offs, structure changes, reviewer decisions |
| AI context engineering | Farnsworth | Copilot instructions, MCP guidance, prompt structure, agent workflows |
